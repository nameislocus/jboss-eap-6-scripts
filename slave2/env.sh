...
#export BIND_ADDR=10.64.160.204
...
export MGMT_ADDR=10.64.160.204
export DOMAIN_MASTER_ADDR=10.64.160.204
export DOMAIN_MASTER_PORT=9999

export HOST_CONTROLLER_PORT=29999
...
# JVM Options : Memory 
export JAVA_OPTS=" $JAVA_OPTS -Xms64m -Xmx128m -XX:MaxPermSize=256m -Xss128k"
